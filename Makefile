...
coverage: ## check code coverage quickly with the default Python
	coverage run --source esignanywhere_python_client runtests.py tests
	coverage report -m
	coverage html
	open htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/esignanywhere-python-client.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ esignanywhere_python_client
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
