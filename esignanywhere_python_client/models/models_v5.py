...
class DisposableCertificateData(BaseModel):
    CountryResidence: str | None
    DocumentIssuingCountry: str | None
    IdentificationCountry: str | None
    IdentificationType: Optional["IdentificationType"]
    PhoneMobile: str | None
    DocumentType: Optional["DocumentType"]
    DocumentIssuedBy: str | None
    DocumentIssuedOn: datetime | None
    DocumentExpiryDate: datetime | None
    SerialNumber: str | None
    DocumentNumber: str | None
    OverrideHolderInCaseOfMismatch: bool | None
...
class Pkcs7SignerData(BaseModel):
    AllowedPkcs7SignatureTypes: list[AllowedPkcs7SignatureType] | None
...
class BankIdPluginData(BaseModel):
    ...
    TrBiAllowAnyPersonalNumber: bool | None
...
class Error(BaseModel):
    ...
    ThrownException: dict[str, Any] | None
...
class EnvelopeBasicOptions(BaseModel):
    ...
    MetaDataXml: str | None = Field(None)
...
class ExtendedFindUsersResultEntry(BaseModel):
    ...
    Authentications: list[UserAuthentication] | None
    Roles: list[str] | None = Field(
...
class SwissComCertificateData(BaseModel):
    ...
    MobileId: str | None
    Parameters: list[KeyValuePair] | None
...
class SentDocument(BaseModel):
    PageSizesInPoints: list[Size] | None
    DocRefNumber: int | None
    FileName: str | None
    FormFields: list[DocumentFormField] | None


class FinishedDocument(BaseModel):
    FlowDocumentId: str | None
    LogDocumentId: str | None
    Attachments: list[DocumentAttachment] | None
    SignedSignatureFields: list[DocumentSignatureField] | None
    DocRefNumber: int | None
    FileName: str | None
    FormFields: list[DocumentFormField] | None
...
class SendEnvelopeResult(BaseModel):
    BulkChildrenIds: list[SendEnvelopeBulkResultEntry] | None
    EnvelopeId: str | None
...
class UserDescription(BaseModel):
    ...
    DefaultSubject: str | None
    DefaultMessage: str | None
...
class ExtendedFindUsersResult(BaseModel):
    Entries: list[ExtendedFindUsersResultEntry] | None
...
class Navigation(BaseModel):
    ...
    LinkTargets: list[LinkTarget] | None
...
class AdHocWorkstepConfiguration(BaseModel):
    ...
    TransactionCodeConfigurations: list[TransactionCodeConfiguration] | None = Field(
...
class PrepareSendEnvelopeStepsResult(BaseModel):
    ...
    Steps: list[SendEnvelopeStep] | None
...
class Signature(WorkstepTask):
    ...
    AdditionalParameters: list[KeyValuePair] | None
    AllowedSignatureTypes: list[SigType] | None = Field(
        None,
        description="Abstract class, use the derived classes:\r\n- SigTypeAutomaticSignature\r\n- SigTypeBiometricSignature\r\n- SigTypeBiometricSignatureAndLocalCertificate\r\n- SigTypeExternalSigningProcess\r\n- SigTypeLocalCertificate\r\n- SigTypeClick2Sign\r\n- SigTypeDraw2Sign\r\n- SigTypeType2Sign\r\n- SigTypeTransactionCode\r\n- SigTypeTransactionCodeAndBiometricSignature\r\n- SigTypeTransactionCodeAndLocalCertificate\r\n- SigTypeTransactionCodeBiometricSignatureAndLocalCertificate\r\n            \r\nFor usage see sample code.",
    )
